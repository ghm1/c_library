...
static void mavlink_test_pixy_cam_pts(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_pixy_cam_pts_t packet_in = {
		93372036854775807ULL,93372036854776311ULL,{ 129.0, 130.0, 131.0, 132.0 },{ 241.0, 242.0, 243.0, 244.0 },{ 353.0, 354.0, 355.0, 356.0 },{ 465.0, 466.0, 467.0, 468.0 }
    };
	mavlink_pixy_cam_pts_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        	packet1.count = packet_in.count;
        
        	mav_array_memcpy(packet1.x, packet_in.x, sizeof(float)*4);
        	mav_array_memcpy(packet1.y, packet_in.y, sizeof(float)*4);
        	mav_array_memcpy(packet1.width, packet_in.width, sizeof(float)*4);
        	mav_array_memcpy(packet1.height, packet_in.height, sizeof(float)*4);
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pixy_cam_pts_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_pixy_cam_pts_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pixy_cam_pts_pack(system_id, component_id, &msg , packet1.time_usec , packet1.count , packet1.x , packet1.y , packet1.width , packet1.height );
	mavlink_msg_pixy_cam_pts_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pixy_cam_pts_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.count , packet1.x , packet1.y , packet1.width , packet1.height );
	mavlink_msg_pixy_cam_pts_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_pixy_cam_pts_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pixy_cam_pts_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.count , packet1.x , packet1.y , packet1.width , packet1.height );
	mavlink_msg_pixy_cam_pts_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_target_land_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_target_land_position_t packet_in = {
		93372036854775807ULL,963497880,963498088,963498296,157.0,185.0,213.0,241.0
    };
	mavlink_target_land_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        	packet1.lat = packet_in.lat;
        	packet1.lon = packet_in.lon;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_position_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_target_land_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_position_pack(system_id, component_id, &msg , packet1.time_usec , packet1.lat , packet1.lon , packet1.alt , packet1.x , packet1.y , packet1.z , packet1.yaw );
	mavlink_msg_target_land_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.lat , packet1.lon , packet1.alt , packet1.x , packet1.y , packet1.z , packet1.yaw );
	mavlink_msg_target_land_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_target_land_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_position_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.lat , packet1.lon , packet1.alt , packet1.x , packet1.y , packet1.z , packet1.yaw );
	mavlink_msg_target_land_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_target_land_offset(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_target_land_offset_t packet_in = {
		93372036854775807ULL,73.0,101.0,129.0,157.0
    };
	mavlink_target_land_offset_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        	packet1.x = packet_in.x;
        	packet1.y = packet_in.y;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_offset_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_target_land_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_offset_pack(system_id, component_id, &msg , packet1.time_usec , packet1.x , packet1.y , packet1.z , packet1.yaw );
	mavlink_msg_target_land_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_offset_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.x , packet1.y , packet1.z , packet1.yaw );
	mavlink_msg_target_land_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_target_land_offset_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_target_land_offset_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.x , packet1.y , packet1.z , packet1.yaw );
	mavlink_msg_target_land_offset_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_home_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_home_position_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,{ 185.0, 186.0, 187.0, 188.0 },297.0,325.0,353.0
    };
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_pixy_cam_pts(system_id, component_id, last_msg);
	mavlink_test_target_land_position(system_id, component_id, last_msg);
	mavlink_test_target_land_offset(system_id, component_id, last_msg);
